...
const LandingPage = () => {
  ...
  // Navigation Handler now accepts a section ID
  ...
  return (
    <>
      ...
      <style>
        {`
          .landing-container-scroll::-webkit-scrollbar {
            display: none;
          }
      ...
      <div 
        ...
        style={{ 
          ...
          color: '#fff', 
          overflowX: 'hidden', 
          overflowY: 'scroll', // Enables scrolling within this container
